...
# INPUT DATA ###
TIME_CLOSE = 4  # SECONDS (VALVE CLOSURE DURATION)
TIME = 30  # SECONDS OF ANALYSIS
VEL0 = 15.0  # FEET/SEC (INITIAL FLUID VELOCITY)
PRESS_US = 2000  # PSI (PRESSURE AT EOT)
...
SPG = FLUID_WEIGHT/62.4  # SPECIFIC GRAVITY OF FLUID
sf.valprint("FLUID GRAVITY", SPG)
FLUID_COMP = sf.compressibility(FLUID_TEMP, FLUID_PRES, FLUID)  # 1/PSI
sf.valprint("FLUID COMPRESSIBILITY", FLUID_COMP)
WAVE_SPEED_FLUID = sf.speedOfSound(FLUID_TEMP, FLUID_PRES, FLUID)  # FT/SEC
